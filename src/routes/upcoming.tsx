  ...
  return (
    <Layout>
      ...
      <section className="container-prose py-16">
        <ol className="relative border-l-2 border-gold/40 pl-8 space-y-8 max-w-4xl mx-auto">
          {items.map((it, i) => (
            <li key={i} className="relative">
              ...
              <div className="rounded-2xl border border-border bg-card overflow-hidden grid sm:grid-cols-[180px_1fr] hover-lift">
                ...
                <div className="p-5">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    <Link to="/tours/$slug" params={{ slug: it.tour.slug }} className="inline-flex rounded-full border border-border px-4 py-2 text-xs hover:border-primary hover:text-primary transition-colors">View Tour</Link>
